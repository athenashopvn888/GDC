...
export const metadata: Metadata = {
  ...
  description:
    "Visit Green Deal Cannabis at 1664 Jane St, York, ON M9N 2S1. Open 24 hours daily. Walk-ins welcome.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "1664 Jane St, York. Open 24 hours daily. Premium cannabis, always fire.",
  },
};
