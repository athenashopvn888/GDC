...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Green Deal" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="GDC01" />
      <input type="hidden" name="StoreName" value="Green Deal Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Green Deal Cannabis?</span>
