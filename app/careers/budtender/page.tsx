...
export const metadata: Metadata = {
  title: { absolute: "Budtender Or Manager Application | Green Deal Cannabis" },
  description:
    "Apply online for budtender or manager opportunities at Green Deal Cannabis. Submit availability, customer-service experience, motivation, determination, and a required selfie.",
  alternates: {
    canonical: "https://www.greendealcannabis.com/careers/budtender",
  },
};
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with Green Deal.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>Green Deal Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              Green Deal Cannabis is collecting applications from sharp, friendly budtender and manager candidates who can help customers shop with confidence and keep the store running smooth.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Late-shift availability is a plus at Green Deal</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className={styles.contentGrid}>
          ...
          <section id="application" className={styles.formPanel} aria-label="Budtender application form">
            <div className={styles.formIntro}>
              ...
              <p>
                This form sends your response to the shared Athena Store Applications sheet under GDC01.
              </p>
