...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    title: "York Weed Dispensary - Green Deal Cannabis | Open 24 Hours | Jane St",
    metaDescription: "Green Deal Cannabis is located at 1820 Jane St in York, Toronto. Open 24 hours daily with menu categories for flower, edibles, vapes, concentrates, pre-rolls, cigarettes, and accessories.",
    h1: "York Weed Dispensary - Green Deal Cannabis",
    icon: "",
    heroTagline: "Cannabis on Jane St - Open 24 Hours Daily - Walk-In Welcome",
    sections: [
      ...
      { heading: "Open 24 Hours Daily on Jane Street", body: "Green Deal Cannabis is open 24 hours daily, 7 days a week. The store is located at 1820 Jane St in York near Weston Road and TTC routes serving the area." },
    ],
    faqs: [
      { q: "Where is Green Deal Cannabis located?", a: "Green Deal Cannabis is located at 1820 Jane St, York, ON M9N 2T3." },
      { q: "What are the hours for Green Deal Cannabis?", a: "Green Deal Cannabis is open 24 hours daily, 7 days a week." },
  ...
  },
  {
    ...
    metaDescription: "Compare Budget, AA, AAA+, Premium, and Exotic flower tiers at Green Deal Cannabis. Open 24 hours daily at 1820 Jane St.",
    h1: "Cheap Weed York - Budget Cannabis Guide",
    icon: "",
    heroTagline: "Compare Flower Tiers - Open 24 Hours Daily",
    sections: [
    ...
    faqs: [
      ...
      { q: "Where is Green Deal Cannabis?", a: "The store is at 1820 Jane St in York and is open 24 hours daily." },
    ],
  },
  {
    slug: "native-cigarettes-york",
    title: "Native Cigarettes York | Green Deal Cannabis",
    metaDescription: "Use the cigarette category at Green Deal Cannabis to review current Native cigarette listings. 1820 Jane St. Open 24 Hours Daily.",
    h1: "Native Cigarettes York",
    icon: "",
    heroTagline: "Cigarette Category Guide - Open 24 Hours Daily",
    heroPreview: {
    ...
    faqs: [
      ...
      { q: "What are the store hours?", a: "Green Deal Cannabis is open 24 hours daily." },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What are the store hours?", a: "Green Deal Cannabis is open 24 hours daily for store visits." },
    ],
  },
  {
    slug: "dispensary-near-me-york",
    title: "Cannabis Dispensary Near Me York - Green Deal Cannabis | Open 24 Hours Daily",
    metaDescription: "Green Deal Cannabis is located at 1820 Jane St in York, Toronto. Open 24 hours daily with store details and menu-category links.",
    h1: "Cannabis Dispensary Near Me - York",
    icon: "",
    heroTagline: "Walk-In Welcome - Open 24 Hours Daily",
    sections: [
    ...
    faqs: [
      ...
      { q: "Is Green Deal Cannabis walk-in friendly?", a: "Yes. The store is open 24 hours daily." },
