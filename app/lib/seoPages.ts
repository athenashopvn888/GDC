/* ── Geo-targeted SEO landing pages for York & Toronto keywords ── */
...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Our unique tier system ensures transparent pricing and quality grading so you always know what you're getting. Exotic ($10-$12/g) features top-shelf, ultra-rare genetics with THC levels reaching 30-34% — these are the strains connoisseurs travel across York and Etobicoke to find. Premium ($7-$10/g) offers connoisseur-grade strains at THC 25-33%, balancing quality and value. AAA+ ($5-$6/g) delivers heavy hitters at THC 22-28% — our most popular tier for experienced users. AA ($4/g) provides quality daily drivers at THC 18-24%, perfect for regular consumption. Budget ($3/g) offers value ounces from $40 without sacrificing reliability. Every tier is lab-tested, properly cured, and freshly rotated.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Green Deal Cannabis carries one of the widest selections of native cigarettes in York. Located at 1820 Jane St in Toronto, we stock a comprehensive range of both premium and value native cigarette brands at competitive prices. Whether you prefer full-flavour, light, menthol, or specialty blends, our tobacco selection has something for every smoker. We're proud to be one of the few stores in downtown York that combines a full cannabis dispensary with a comprehensive tobacco counter — one stop for everything you need.",
      },
      {
      ...
      },
      {
        ...
        body: "Our shop at 1820 Jane St is centrally located in York — easily accessible from Lawrence Ave W, Weston Rd, and major Toronto arteries. Whether you're walking, driving, or taking the bus, Green Deal Cannabis is easy to reach. TTC bus routes 35 Jane and 89 Weston drop you off right near our doors. We serve customers from across York, Etobicoke, North York, and Vaughan.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Need weed delivered fast in York or surrounding Toronto areas? Green Deal Cannabis offers a premier same-day weed delivery service. Whether you're located in York, Weston, North York, Etobicoke, Vaughan, or central Toronto, we bring the best dispensaries directly to your home. Enjoy our full live menu of flower, edibles, vapes, and concentrates delivered discreetly and safely.",
      },
      {
      ...
      },
      {
        ...
        body: "Ordering is incredibly simple. Browse our live digital menu, select your favourite products, and choose the delivery option at checkout. We dispatch deliveries promptly so you don't have to wait. We offer flexible, secure payment options for a seamless, hassle-free experience from start to finish.",
      },
      {
        heading: "Delivery Areas We Cover",
        body: "Our delivery network spans across York and neighbouring areas including: Weston, Mount Dennis, Silverthorn, Humber Heights, Pelham Park, Kingsview Village, Rexdale, Etobicoke, Downsview, Willowdale, North York, Vaughan, and central Toronto. Check our delivery page at greendealcannabis.com for exact delivery windows and minimum order requirements for your postal code.",
      },
    ],
    faqs: [
    ...
    sections: [
      {
        ...
        body: "If you're searching for a cannabis dispensary near you in York or Toronto, Green Deal Cannabis is conveniently located at 1820 Jane St — easily accessible from Lawrence Ave W, Weston Rd, and major GTA transit routes. We serve customers from across York, North York, Etobicoke, Vaughan, and central Toronto.",
      },
      {
      ...
      },
      {
        ...
        body: "Green Deal Cannabis is centrally located and easily accessible from anywhere in York. We regularly serve customers from: Weston, Mount Dennis, Silverthorn, Humber Heights, Pelham Park, Kingsview Village, Rexdale, Etobicoke, Downsview, Willowdale, North York, Vaughan, and central Toronto. We're near the Weston GO Station and TTC routes.",
      },
    ],
    faqs: [
