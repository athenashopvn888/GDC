...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>1820 Jane St, York</strong>. We are open daily <strong>10am - 2am</strong>. Call <strong>+1 (437) 292-0413</strong>.</p></div>
