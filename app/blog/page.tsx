...
const STATIC_POSTS = [
  ...
  {
    slug: "best-dispensary-york",
    title: "Why Green Deal Cannabis is York's Best Dispensary",
    excerpt: "200+ strains, transparent pricing from $3/g, lab-tested products, and open 10am - 2am Daily. Here's what makes us different.",
    date: "2026-05-03",
    category: "News",
    emoji: "🔥",
    readTime: "3 min",
  ...
  {
    slug: "york-cannabis-laws-2026",
    title: "York Cannabis Laws in 2026 — What You Need to Know",
    excerpt: "Age limits, public consumption rules, possession limits, and where you can legally smoke in York. Stay informed.",
    date: "2026-04-25",
    category: "News",
    emoji: "⚖️",
    readTime: "4 min",
...
/* ── Google Reviews ── */
const REVIEWS = [
  { name: "Mike R.", rating: 5, text: "Best dispensary in the York area. Staff is super knowledgeable and the exotic strains are legit fire.", date: "2 weeks ago" },
  { name: "Sarah L.", rating: 5, text: "Love that they're open 10am - 2am daily. The selection is insane — over 200 strains. My go-to spot.", date: "1 month ago" },
...
export default function BlogPage() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=GDC01`)
      .then((r) => r.json())
  ...
  return (
    <main className={styles.main}>
      ...
      <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
        <img
          src="/banners/Green Deal Cannabis_Blog.webp"
          alt="Green Deal Cannabis Blog"
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Green Deal Cannabis <span className={styles.heroAccent}>Blog</span>
          </h1>
          <p className={styles.heroSub}>
            Cannabis guides, strain reviews, and dispensary news from York&apos;s
            premium dispensary.
          </p>
        </div>
      </section>
      ...
      <section className={styles.ctaSection}>
        <div className={styles.ctaInner}>
          ...
          <p className={styles.ctaSub}>
            200+ strains · Exotic to Budget · Open 10am - 2am Daily
          </p>
