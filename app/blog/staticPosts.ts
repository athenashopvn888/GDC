...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a Green Deal Cannabis Visit Without Guessing",
    "seoTitle": "Green Deal Cannabis Visit Guide | Weed Dispensary in York",
    "seo_title": "Green Deal Cannabis Visit Guide | Weed Dispensary in York",
    "metaDescription": "Plan a Jane St in York visit to Green Deal Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Jane St in York visit to Green Deal Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a Green Deal Cannabis Visit Without Guessing",
    "excerpt": "A practical visit guide for Green Deal Cannabis, written for shoppers who want the next step without the runaround.",
    "author": "Drew Deal",
  ...
  },
  {
    ...
    "title": "How to Compare Green Deal Cannabis Flower Without Guessing",
    "seoTitle": "Green Deal Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "Green Deal Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Green Deal Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Green Deal Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Green Deal Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Green Deal Cannabis.",
    "author": "Kara Green",
    "authorName": "Kara Green",
    "authorHandle": "@KaraDealGuide",
    "authorRole": "House Writer",
  ...
  },
  {
    ...
    "title": "How to Shop the Green Deal Cannabis Menu Like a Pro",
    "seoTitle": "Green Deal Cannabis Menu Guide | York Weed Store",
    "seo_title": "Green Deal Cannabis Menu Guide | York Weed Store",
    "metaDescription": "Shop the Green Deal Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Green Deal Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Green Deal Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Green Deal Cannabis menu without turning the visit into a guessing game.",
    "author": "Drew Deal",
    "authorName": "Drew Deal",
    "authorHandle": "@DrewGreenDeal",
    "authorRole": "House Writer",
