...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "Green Deal Cannabis Price and Flower Tier Guide",
    seoTitle: "Green Deal Cannabis Price Tier Guide",
    seo_title: "Green Deal Cannabis Price Tier Guide",
    metaDescription: "Green Deal Cannabis guide to flower tiers, weight choices, unit value, and store visit planning in York.",
    meta_description: "Green Deal Cannabis guide to flower tiers, weight choices, unit value, and store visit planning in York.",
    h1: "Green Deal Cannabis Price and Flower Tier Guide",
    excerpt: "A simple guide to Green Deal Cannabis flower tiers, weights, and unit value.",
    author: "The Green Deal Cannabis Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Green Deal Cannabis Price and Flower Tier Guide

Green Deal Cannabis makes flower shopping easier by organizing the menu into clear tiers. Start with the tier that matches the kind of flower you want, then choose the weight that fits your budget and visit.
...
For the smoothest visit, open the Green Deal Cannabis menu before heading out. The live menu is the best place to compare current flower tiers, weights, and store-specific options. The store page is also useful for directions, contact details, and visit planning.

If you are comparing flower tiers in York, use this page as the simple guide, then use the live menu for the current selection.

## Helpful Next Steps

- Compare [Exotic flower](/exotic), [Premium flower](/premium), [AAA+ flower](/aaa), [AA flower](/aa), and [Budget flower](/budget).
- Open the Green Deal Cannabis store page for directions, contact details, and visit planning.
...
Use the live menu for current store-specific selection, then use the store page for directions, contact details, and visit planning.`,
  ...
  },
  {
    ...
    title: "Green Deal Cannabis Local Visit Guide for Adults 19+",
    seoTitle: "Green Deal Cannabis Local Visit Guide | York Adult 19+",
    seo_title: "Green Deal Cannabis Local Visit Guide | York Adult 19+",
    metaDescription: "Plan a visit to Green Deal Cannabis in York with adult 19+ store-page checks, menu-category paths, and local directions context.",
    meta_description: "Plan a visit to Green Deal Cannabis in York with adult 19+ store-page checks, menu-category paths, and local directions context.",
    h1: "Green Deal Cannabis Local Visit Guide for Adults 19+",
    excerpt: "Green Deal Cannabis guide for adults 19+ checking local context, store pages, and menu-category paths around York / Weston.",
    author: "The Green Deal Cannabis Team",
    date: "2026-07-09",
    category: "Local Guide",
    readTime: "5 min",
    content: `Use this guide to confirm the right Green Deal Cannabis storefront around York / Weston, understand nearby street context, and choose the most useful store page or menu path before visiting.

For current details, start with the official store page or contact staff before leaving.

## Confirm The Right Storefront

Green Deal Cannabis is tied to York, Weston, local main roads, nearby neighbourhood routes. Local shoppers often compare several nearby search results, so the first job of this page is to make the store identity, area context, and next click easy to understand.
...
Searches near York / Weston usually come from shoppers who already have a real-world route in mind. Mentioning nearby streets, neighbourhood language, and local travel context helps the page match how people actually search without inventing claims.
...
- Open the Green Deal Cannabis store page: [https://www.greendealcannabis.com/weed-dispensary-york](https://www.greendealcannabis.com/weed-dispensary-york)
- Browse more local guides from the blog: [https://www.greendealcannabis.com/blog](https://www.greendealcannabis.com/blog)
- Confirm store-specific details before heading out.

## FAQ

### Is this guide only for Green Deal Cannabis?

Yes. This page is written for Green Deal Cannabis and the York / Weston area.
...
Local shoppers search with neighbourhood and street language. Clear local context helps them confirm they are looking at the right store.`,
    ...
    internal_links_used: "/weed-dispensary-york, /blog, /blog/green-deal-cannabis-local-visit-guide-2026",
    relatedLinks:     [
          {
                "title": "Green Deal Cannabis store page",
                "url": "https://www.greendealcannabis.com/weed-dispensary-york",
                "description": "Official Green Deal Cannabis page for local visit planning."
          },
          {
                "title": "Green Deal Cannabis homepage",
                "url": "https://www.greendealcannabis.com/",
                "description": "Start from the Green Deal Cannabis homepage."
          },
          {
                "title": "More Green Deal Cannabis guides",
